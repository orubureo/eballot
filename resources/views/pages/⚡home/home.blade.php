<div>
    ...
    {{-- Hero --}}
    <div class="hero-gradient-bg relative min-h-screen flex flex-col md:flex-row items-center gap-12 px-8 py-24 md:px-16 md:py-12 overflow-hidden" style="background-image: linear-gradient(135deg, oklch(0.52 0.08 176.23) 0%, oklch(0.39 0.07 217.51) 100%);">

        <div class="absolute inset-0 opacity-10"
            style="background-image: radial-gradient(circle, white 1px, transparent 1px); background-size: 32px 32px;">
        </div>
        <div class="blob-float-1 absolute top-0 right-0 w-96 h-96 rounded-full opacity-20 blur-3xl"
            style="background: oklch(0.98 0.03 161.89);">
        </div>
        <div class="blob-float-2 absolute bottom-0 left-0 w-72 h-72 rounded-full opacity-20 blur-3xl"
            style="background: oklch(0.81 0.02 196.7);">
        </div>

        <div class="md:w-1/2 relative reveal">
            ...
            <div class="flex flex-wrap gap-3 mb-12">
                <a href="{{ route('onboarding') }}" wire:navigate
                    class="btn bg-white text-primary rounded-full hover:bg-white/90 hover:scale-105 transition-transform border-0">
                    Register to vote
                </a>
                <a href="{{ route('login') }}" wire:navigate
                    class="btn bg-white/10 text-white border border-white/30 rounded-full hover:bg-white/20 hover:scale-105 transition-transform backdrop-blur-sm">
                    Sign in
                </a>
            </div>
            ...
            <div class="flex gap-8" x-data="{
                stats: [
                    { target: 2.4, suffix: 'M+', decimals: 1, value: 0 },
                    { target: 99.99, suffix: '%', decimals: 2, value: 0 },
                    { target: 128, suffix: '-bit', decimals: 0, value: 0 },
                ],
                started: false,
                start() {
                    ...
                    this.stats.forEach((s, i) => {
                        ...
                        const timer = setInterval(() => {
                            ...
                            this.stats[i].value = current;
                        }, duration / steps);
                    });
                }
            }" x-intersect.once="start()">
                <div>
                    <p class="text-2xl font-semibold text-white" x-text="stats[0].value.toFixed(stats[0].decimals) + stats[0].suffix">0.0M+</p>
                    <p class="text-sm text-white/50">Votes cast</p>
                </div>
                <div class="w-px bg-white/20"></div>
                <div>
                    <p class="text-2xl font-semibold text-white" x-text="stats[1].value.toFixed(stats[1].decimals) + stats[1].suffix">0.00%</p>
                    <p class="text-sm text-white/50">Uptime</p>
                </div>
                <div class="w-px bg-white/20"></div>
                <div>
                    <p class="text-2xl font-semibold text-white" x-text="Math.round(stats[2].value) + stats[2].suffix">0-bit</p>
                    <p class="text-sm text-white/50">Encryption</p>
                </div>
            </div>
        </div>

        <div class="md:w-1/2 flex justify-center relative reveal reveal-delay-2">
            <div class="absolute size-72 rounded-full blur-3xl opacity-30 bg-white blob-float-1"></div>
            <div class="card w-80 shadow-2xl bg-white/95 backdrop-blur-sm border border-white/50 relative hover-lift">
                <div class="card-body">
                    ...
                    <button class="btn btn-primary rounded-full mt-4 w-full shadow-lg hover:scale-[1.02] transition-transform">
    ...
    <div class="px-8 py-20 md:px-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mx-auto">
            <div class="reveal reveal-delay-1 hover-lift flex flex-col items-center text-center bg-white p-5 rounded-xl border border-base-300 shadow">
            ...
            <div class="reveal reveal-delay-2 hover-lift flex flex-col items-center text-center bg-white p-5 rounded-xl border border-base-300 shadow">
            ...
            <div class="reveal reveal-delay-3 hover-lift flex flex-col items-center text-center bg-white p-5 rounded-xl border border-base-300 shadow">
        ...
        @else
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-5xl mx-auto">
                @foreach ($liveElections as $election)
                    <div class="reveal hover-lift card bg-white shadow-md rounded-2xl border border-base-300">
                        <div class="card-body">
                            ...
                            <div class="card-actions mt-4">
                                <a href="{{ route('onboarding') }}" wire:navigate class="btn btn-primary btn-sm rounded-full w-full hover:scale-[1.02] transition-transform">Vote now</a>
                            </div>
                        </div>
                    </div>
                @endforeach
    ...
    <div class="px-8 py-20 md:px-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mx-auto">
            <div class="reveal hover-lift bg-white rounded-xl p-6 border border-base-300 shadow duration-300">
            ...
            <div class="reveal reveal-delay-1 hover-lift bg-white rounded-xl p-6 border border-base-300 shadow duration-300">
            ...
            <div class="reveal reveal-delay-2 hover-lift bg-white rounded-xl p-6 border border-base-300 shadow duration-300">
            ...
            <div class="reveal bg-white rounded-xl p-6 border border-base-300 shadow duration-300 hover-lift">
            ...
            <div class="reveal reveal-delay-1 bg-white rounded-xl p-6 border border-base-300 shadow duration-300 hover-lift">
            ...
            <div class="reveal reveal-delay-2 bg-white rounded-xl p-6 border border-base-300 shadow duration-300 hover-lift">
    ...
    <div class="bg-white px-8 py-20 md:px-16">
        <div class="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div class="reveal reveal-delay-2 hover-lift bg-white shadow rounded-2xl border border-base-300 p-8">
    ...
    {{-- CTA --}}
    <div class="bg-primary px-8 py-20 md:px-16 text-center reveal">
        ...
        <div class="flex gap-3 justify-center">
            <a href="{{ route('onboarding') }}" wire:navigate class="btn bg-white text-primary rounded-full hover:bg-white/90 hover:scale-105 transition-transform">Register to vote</a>
            <a href="{{ route('login') }}" wire:navigate class="btn btn-outline text-white border-white rounded-full hover:bg-white/10 hover:scale-105 transition-transform">Sign in</a>
        </div>
    </div>
    ...
    <div class="px-8 py-20 md:px-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            ] as $i => [$initials, $color, $name, $role, $quote])
                <div class="reveal {{ $i === 1 ? 'reveal-delay-1' : ($i === 2 ? 'reveal-delay-2' : '') }} hover-lift bg-white shadow rounded-xl p-6 border border-base-300">
    ...
    <div class="bg-white px-8 py-20 md:px-16">
        <div class="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div class="reveal">
                ...
                <a href="{{ route('onboarding') }}" wire:navigate class="btn btn-primary rounded-full hover:scale-105 transition-transform">Get started free</a>
            </div>
            <div class="reveal reveal-delay-2 flex justify-center">
                <div class="mockup-phone border-primary blob-float-1">
    ...
    <div class="bg-white px-8 py-20 md:px-16">
        ...
        <div class="max-w-2xl mx-auto space-y-2 reveal">
            @foreach ([
